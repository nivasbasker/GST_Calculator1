...
public class AdapterInvoice extends RecyclerView.Adapter<AdapterInvoice.ViewHolder> {
    ...
    @NonNull
    @Override
    public AdapterInvoice.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.layout_invoice, parent, false);
        return new AdapterInvoice.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.t1.setText("#" + model.getInvNum());
        holder.t2.setText(String.valueOf(model.getDate()));
